...
const benefits = [
  {
    ...
    icon: (
      <FaMoneyBillAlt
        className="mx-auto w-auto h-[137px] mb-3 text-blue-600"
        size={28}
      />
    ),
  },
  {
    ...
    icon: (
      <FaLightbulb
        className="mx-auto w-auto h-[100px] mb-6 text-blue-600"
        size={28}
      />
    ),
  },
...
export default function ManfaatSection() {
  return (
    <section className="max-w-[1480px] mx-auto rounded-2xl md:rounded-3xl shadow-xl w-full bg-white">
      ...
      <div className="flex flex-col md:flex-row">
        {benefits.map((benefit, index) => (
          <div
            key={index}
            className="flex flex-col flex-1 relative px-6 min-h-[400px] items-center justify-center"
          >
            {/* Icon */}
            ...
            {index !== benefits.length - 1 && (
              <div className="block md:hidden absolute left-0 bottom-0 w-full">
