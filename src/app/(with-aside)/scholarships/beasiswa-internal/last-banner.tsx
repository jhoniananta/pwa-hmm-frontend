  ...
  return (
    <>
      <section className="flex mx-auto my-0 w-full h-full max-w-[1480px] max-md:flex-col max-md:h-auto">
        <div className="flex relative flex-col gap-4 items-center justify-center h-auto max-md:rounded-t-2xl md:rounded-l-3xl bg-blue-950 max-w-[500px] max-md:w-full max-md:h-auto max-sm:p-5 w-1/2 min-h-[400px]">
          <Image
            src="/images/informasi-beasiswa/bg-handshake.png"
            width={500}
            height={539}
            alt="background"
        ...
        <div className="relative w-1/2 flex-1 p-10 bg-indigo-700 md:rounded-r-3xl max-md:p-8 max-md:w-full max-md:h-auto max-sm:p-5 max-md:rounded-b-2xl">
          <Image
