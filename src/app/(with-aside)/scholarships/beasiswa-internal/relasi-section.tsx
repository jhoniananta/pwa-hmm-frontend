  ...
  return (
    <div className='flex flex-col gap-8 md:gap-10'>
      <section className="flex mx-auto my-0 w-full h-full max-w-[1480px] max-md:flex-col max-md:h-auto">
        <div className="flex relative flex-col gap-4 items-center justify-center p-10 h-auto max-md:rounded-t-2xl md:rounded-l-3xl bg-blue-950 w-[404px] max-md:p-8 max-md:w-full max-md:h-auto max-sm:p-5">
          <Image
            src="/images/informasi-beasiswa/bg-sekapur-sirih.png"
            width={348}
            height={438}
            alt="background"
        ...
        <div className="relative flex-1 p-10 bg-indigo-700 md:rounded-r-3xl max-md:p-8 max-md:w-full max-md:h-auto max-sm:p-5 max-md:rounded-b-2xl">
          <Image
      ...
      <section className='flex items-center justify-center rounded-3xl max-w-[1480px] w-full mx-auto border-blue-950 border-4 shadow-xl'>
