    ...
    return (
        <section className="rounded-none w-full h-auto mx-10">
            <div className="flex gap-8 md:gap-6 flex-col-reverse md:flex-row justify-center">
                <div
                    className="w-1/2 max-w-[720px] max-md:w-full bg-blue-950 relative text-white max-md:rounded-2xl md:rounded-3xl">
                    <Image
                        unoptimized={true}
                ...
                <div
                    ...
                    <Image
                        unoptimized={true}
                        src="/assets/images/informasi-beasiswa/bg-visi-misi.png"
                        width={720}
                        height={550}
                        alt="background"
