...
export default function TujuanBeasiswaSection() {
  return (
    <>
      <section className="flex flex-row mx-auto my-0 w-full h-full max-w-[1480px] max-md:flex-col max-md:h-auto gap-8 md:gap-6 relative">
        ...
        <div className="max-w-[720px] h-full md:max-h-[550px] max-md:rounded-2xl md:rounded-3xl relative bg-white md:w-1/2 py-12 px-8">
          ...
          <Image
            src="/images/informasi-beasiswa/tl-bg.png"
            alt="top left icon"
            width={120}
            height={102}
          ...
          <Image
            src="/images/informasi-beasiswa/br-bg.png"
