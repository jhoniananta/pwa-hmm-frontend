...
export default function BeasiswaInternalBanner() {
  return (
    <div className="flex relative flex-col max-sm:px-5 max-sm:py-6 px-14 py-16 min-w-full rounded-[20px] min-h-[552px] max-md:w-full max-md:origin-top shadow-lg">
      <Image
        src="/images/bg-hmm-internal.png"
      ...
      <div className="flex relative flex-wrap gap-5 justify-between font-bold max-md:mr-1">
        <div className="text-8xl leading-[70px] text-zinc-900 max-md:text-4xl max-md:leading-9">
          <div className="flex shrink-0 border-black border-solid border-[7px] max-sm:w-[60px] max-sm:h-[60px] h-[118px] rounded-[129px] w-[118px]" />
        ...
        <div className="self-end grid grid-rows-3 gap-4 mt-11 max-sm:text-lg text-2xl text-center text-blue-950 max-md:mt-10">
          <Button
            variant={'outline'}
