          ...
          <div className="max-w-[1355px] p-6 flex flex-col w-full justify-center gap-4">
            ...
            >
              ...
              <div>
                ...
                <input
                  type="text"
                  {...register('namaMahasiswa', { required: true })}
              ...
              <div>
                ...
                <input
                  type="number"
                  {...register('nim', { valueAsNumber: true, required: true })}
                  className="w-full border border-gray-300 p-2 rounded"
              ...
              <div>
                <label className="block font-medium mb-1">
                  Surat Permohonan Beasiswa Ditanda tangani Orang Tua dan Calon
                  Penerima Beasiswa
                </label>
                <input
                  type="file"
              ...
              <div>
                <label className="block font-medium mb-1">
                  Curriculum Vitae (Lampirkan Fotokopi KTP Mahasiswa, Kartu
                  Keluarga, dan Kartu Tanda Mahasiswa)
                </label>
                <input
                  type="file"
                  accept=".pdf"
