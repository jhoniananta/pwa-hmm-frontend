            ...
            <Table className='table-admin'>
                ...
                <TableBody>
                    {data.map((scholarship, index) => {
                        ...
                        return (
                            <TableRow key={scholarship.scholarshipId} className='even:bg-navy/5 odd:bg-transparent'>
                                    ...
                                    <Popover>
                                        ...
                                        >
                                            <div className='flex flex-col text-sm *:text-left *:font-medium'>
                                                ...
                                                <Link
                                                    href={`/portal/admin/scholarships/edit/${scholarship.scholarshipId}`}
                                                ...
                                                <button
                                                    onClick={() =>
                                                        executeDelete({scholarshipId: scholarship.scholarshipId})
                                                    }
