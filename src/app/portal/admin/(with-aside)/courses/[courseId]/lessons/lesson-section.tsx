                    ...
                    {data.map((lesson, index) => {
                        ...
                        return (
                            <TableRow key={lesson.lessonId}>
                                ...
                                <TableCell>{lesson.numberOfVideos}</TableCell>
                                <TableCell>{lesson.numberOfDurations}</TableCell>
                                <TableCell>{lesson.numberOfAttachments}</TableCell>
                                    ...
                                    <Popover>
                                        ...
                                        <PopoverContent align='end' className='w-40 border-navy border p-1'>
                                            <div className='flex flex-col text-sm *:text-left *:font-medium'>
                                                ...
                                                <Link
                                                    href={`/portal/admin/courses/${courseId}/lessons/edit/${lesson.lessonId}`}
